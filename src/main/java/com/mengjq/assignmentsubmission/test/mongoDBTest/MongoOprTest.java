package com.mengjq.assignmentsubmission.test.mongoDBTest;
...
public class MongoOprTest {
    ...
    public void getMySubmittedFileInfo(){
        ...
        FindIterable<Document> docs = mongoDBService.getMySubmittedFileInfo("19852329");
...
//    @Test
//    public void getMySubmit(){
//        FindIterable<Document> myFiles = mongoDBService.getMySubmittedFileInfo("19852324");
